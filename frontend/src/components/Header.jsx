const Header = () => {
  return (
    <>
      <header className="w-full flex flex-col sm:flex-row justify-between items-center px-4 md:px-12 lg:px-20 py-3 sm:py-4 bg-black/30 backdrop-blur-sm border-b border-orange-500/30 shadow-lg fixed top-0 left-0 z-30 gap-3 sm:gap-0">
        {/* Left: College Info */}
